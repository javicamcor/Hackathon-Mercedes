...
def simulate_data():
    ...
    logs_falsos = [
        # Gastos de anteayer
        ("equipo_desarrollo", "gpt-4", "gpt-4", 100, 50, 0.30, "Ninguna", 0.0, anteayer),
        ("equipo_marketing", "gpt-4", "gpt-4", 150, 75, 0.45, "Ninguna", 0.0, anteayer),
        
        # Gastos de ayer
        ("equipo_desarrollo", "gpt-4", "gpt-4", 200, 100, 0.60, "Ninguna", 0.0, ayer),
